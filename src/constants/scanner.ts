...
export const MIN_ANCHOR_DENSITY = 0.28;
...
export const ANCHOR_INSET_END = 0.40;
...
// duplicate rejection — minimum px distance between detection centers
export const MIN_CENTER_DISTANCE = 40;
